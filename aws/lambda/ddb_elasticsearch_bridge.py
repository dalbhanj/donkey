'''
Lambda function for sending data from a DynamoDB stream to Elasticsearch
(Uses python 2.7 runtime)
...
https://github.com/dexterlabora/cmxreceiver-lambda-inline/blob/master/src/cmxreceiver-stream-to-es.py
'''
...
ES_ENDPOINT = 'search-waiterbot-oq6ccfr7mn56cwjpsgm5ga5hja.us-east-1.es.amazonaws.com'
