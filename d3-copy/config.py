...
# #STEERING for Big Car
# STEERING_CHANNEL = 1
# STEERING_LEFT_PWM = 460
# STEERING_RIGHT_PWM = 260


# #THROTTLE for Big Car
# THROTTLE_CHANNEL = 0
# THROTTLE_FORWARD_PWM = 500
# THROTTLE_STOPPED_PWM = 370
# THROTTLE_REVERSE_PWM = 220

#STEERING for Small Car
STEERING_CHANNEL = 1
STEERING_LEFT_PWM = 500
STEERING_RIGHT_PWM = 300	


#THROTTLE for Small Car
THROTTLE_CHANNEL = 0
...
MODEL_MAP = {
    1: os.path.join(MODELS_PATH) + "/left-turn-path-073018",
    2: os.path.join(MODELS_PATH) + "/right-turn-path-073018",
